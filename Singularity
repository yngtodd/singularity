...
%post
  ...
  cd tensorflow
  git checkout tags/v1.3.0-rc2
  # Chery pick fix for bazel 0.5.3
  git cherry-pick c5d311eaf8cc6471643b5c43810a1feb19662d6c 
  ./configure
  ...
  # Install Pytorch - the only real deeplearning package
  pip install http://download.pytorch.org/whl/cu75/torch-0.2.0.post1-cp27-cp27m-manylinux1_x86_64.whl 
  pip install torchvision 
  
  pip3 install http://download.pytorch.org/whl/cu75/torch-0.2.0.post1-cp36-cp36m-manylinux1_x86_64.whl 
  ...
  # Install Hyperspace
  cd /
  git clone git@code.ornl.gov:ygx/hyperspace.git
  cd hyperspace
  pip install -e .
